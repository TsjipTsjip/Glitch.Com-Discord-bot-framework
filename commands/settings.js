...
exports.run = async (client, message, [action, key, ...value], level) => { // eslint-disable-line no-unused-vars
  ...
  if (action === "del") {
    ...
    const response = await client.awaitReply(message, `Are you sure you want to permanently delete ${key}? This **CANNOT** be undone. Please type y to continue or n to abort.`);
...
exports.help = {
  ...
  usage: "settings <add/edit/view/del> <key> <value>"
};
